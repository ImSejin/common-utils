...
public final class Locales {
    ...
    public static Locale[] getLanguages() {
        return new Locale[] {
                ...
                NORWEGIAN_NYNORSK, POLISH, PORTUGUESE, ROMANIAN, RUSSIAN, SERBIAN, SLOVAK, SLOVENIAN, SPANISH, SWEDISH,
    ...
    public static Locale[] getCountries() {
        return new Locale[] {
                ...
                ESTONIA, FINLAND, FRANCE, GERMANY, GREECE, GUATEMALA, HONDURAS, HONG_KONG, HUNGARY, ICELAND, INDIA,
                INDIA_HINDI, INDONESIA, IRAQ, IRELAND, IRELAND_IRISH, ISRAEL, ITALY, JAPAN, JORDAN, KUWAIT, LATVIA,
                LEBANON, LIBYA, LITHUANIA, LUXEMBOURG, LUXEMBOURG_GERMAN, MACEDONIA, MALAYSIA, MALTA_ENGLISH,
                MALTA_MALTESE, MEXICO, MONTENEGRO, MOROCCO, NETHERLANDS, NEW_ZEALAND, NICARAGUA, NORWAY_NORWEGIAN,
                NORWAY_NORWEGIAN_BOKMAL, NORWAY_NORWEGIAN_NYNORSK, OMAN, PANAMA, PARAGUAY, PERU, PHILIPPINES, POLAND,
                PORTUGAL, PUERTO_RICO, QATAR, ROMANIA, RUSSIA, SAUDI_ARABIA, SERBIA, SINGAPORE_ENGLISH,
                SINGAPORE_CHINESE, SLOVAKIA, SLOVENIA, SOUTH_AFRICA, KOREA, SPAIN_SPANISH, SPAIN_CATALAN, SUDAN, SWEDEN,
                SWITZERLAND_FRANCE, SWITZERLAND_GERMAN, SWITZERLAND_ITALIAN, SYRIA, TAIWAN, THAILAND, TUNISIA, TURKEY,
                UKRAINE, UAE, UK, US, US_SPANISH, URUGUAY, VENEZUELA, VIETNAM, YEMEN,
        };
    }
