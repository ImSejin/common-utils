...
public class LeapYearDateTimeArgumentsProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        ...
        LeapYearDateTimeSource annotation = context.getRequiredTestMethod().getAnnotation(LeapYearDateTimeSource.class);
