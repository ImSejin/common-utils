...
class FloatAssertTest {
    ...
    class IsFinite {
        @ParameterizedTest
        @ValueSource(floats = {
                -123.456F, -0.123456F, -Float.MIN_VALUE, 0.0F,
                Float.MIN_VALUE, 0.123456F, 123.456F,
        })
    ...
    class IsInfinite {
        ...
        @ValueSource(floats = {
                -123.456F, -0.123456F, -Float.MIN_VALUE, 0.0F,
                Float.NaN, Float.MIN_VALUE, 0.123456F, 123.456F,
        })
    ...
    class IsNaN {
        ...
        void test0() {
            assertThatNoException().isThrownBy(() -> Asserts.that(Float.NaN).isNaN());
        }
